...
import { profileContainerData, vendorInfoCardData } from "../utils/data";
  ...
  return (
    <div className="w-full">
      <div className="w-full grid grid-cols-3 gap-5">
        {vendorInfoCardData.map((data, index) => (
        ...
        <div className="w-full py-6 h-[85%] ">
          <div className="w-full h-full px-6 overflow-y-auto customScrollbar">
            <div className="w-full flex flex-col gap-8 pb-8">
              {profileContainerData.map(
                ({ Icon, title, text, time, bgColor }, index) => (
                  <div
                  ...
                  >
                    <div className="flex gap-3 items-center">
                      <div
                        className={`w-[50px] h-[50px] rounded-xl ${bgColor} text-xl flex justify-center items-center text-white`}
                      >
                        <Icon />
                      </div>
