    ...
    <div className="flex flex-col gap-5 w-full  h-full items-center">
      ...
      <div className="flex justify-between w-full mt-5">
        <div className="flex flex-col justify-center items-center">
          <h1 className="font-bold text-sm text-gray-600">1703</h1>
          <h2 className="text-gray-400 text-bold">Friends</h2>
        </div>
        <div className="flex flex-col justify-center items-center">
          <h1 className="font-bold text-sm text-gray-600">3005</h1>
          <h2 className="text-gray-400 text-bold">Followers</h2>
        </div>
        <div className="flex flex-col justify-center items-center">
          <h1 className="font-bold text-sm text-gray-600">1150</h1>
